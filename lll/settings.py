...
SECRET_KEY = '(jcz!za!x54!kxnz68%g^e#l8+(t84^n#+07_onhu_&6)5rbrd'
...
WSGI_APPLICATION = 'lll.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'file/static_dev'),
]
